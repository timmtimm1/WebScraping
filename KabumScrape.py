...
def scrape_product_details(product_links, headers):
    all_products = []
...
def save_to_csv(produto_escolhido, all_products):
    df = pd.DataFrame(all_products)
    df.to_csv(f'{produto_escolhido}.csv', index=False)

if __name__ == "__main__":
    produto_escolhido = 'fonte'
    headers = {
    ...
    all_products = scrape_product_details(product_links, headers)
    save_to_csv(produto_escolhido, all_products)
